...
class Detector:
    ...
    def __init__(self):
        ...
        self.whitelisted_labels = {"apple", "banana", "pizza", "orange", "stop_sign"}
    ...
    def camera_common(self, img_laser_ranges, img, img_bgr8):
        ...
        if num > 0:
            ...
            for (box,sc,cl) in zip(boxes, scores, classes):
                ...
                # world_theta = thetaleft
                # world_x, world_y = self.convert_to_world(dist, world_theta)
                # object_msg.x = world_x
                # object_msg.y = world_y
                # object_msg.theta = world_theta
    ...
    def odom_callback(self, msg):
        ...
        euler = tf_2.transformations.euler_from_quaternion(quaternion)
        self.theta = euler[2]
