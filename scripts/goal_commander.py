...
class GoalPoseCommander:
    ...
    def create_transform_msg(self, position, orientation, child_frame, base_frame, time=None):
        t = TransformStamped()
...
#                self.create_transform_msg(nav_pose_origin.pose.position,
#                                     nav_pose_origin.pose.orientation,
#                                     "goal_pose",
#                                     "map"))
